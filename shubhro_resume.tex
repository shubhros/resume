...
\section{\textcolor{teal}{Summary}}
  ...
  \item []{System programmer with 14+ years of experience in Networking, OS, Cloud, File and Distributed systems}
...
\resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Go, C, Python}
      \hfill
     \textbf{Technologies}{: Linux, TCP/IP, Docker, DPDK, OVS}
   }
    \resumeSubHeadingListEnd
...
%\resumeSubHeadingListStart
  ...
  %  \resumeSubHeadingListEnd
%-----------Other Projects-----------------
\section{\textcolor{teal}{Independent Project}}
  Developed a prototype of a policy based distributed file system using FUSE. Worked with a team of 2 developers to develop the prototype and pitch to various investors. The source code is open sourced under GPLv2 and can be found here - \href {https://github.com/seamlessstack/SeamlessStack}{\textcolor{blue}{https://github.com/seamlessstack/SeamlessStack}}
