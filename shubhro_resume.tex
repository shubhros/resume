...
\section{\textcolor{RED}{Summary}}
  ...
  \item []{A technology enthusiast with 12+ years of experience in Networking, DPDK, Cloud and Distributed Computing, Scalable systems, Operating Systems.}
...
\resumeSubHeadingListStart
    \item{
      ...
      \hfill
     \textbf{Technologies}{: Linux, DPDK, OVS, TCP/IP, Docker, Electron}
   }
    \resumeSubHeadingListEnd
